...
static constexpr JPH_ObjectLayerPairFilter_Impl objectLayerPairFilterImpl = {
...
static constexpr JPH_BroadPhaseLayerInterface_Impl broadPhaseLayerInterfaceImpl = {
...
static constexpr JPH_ObjectVsBroadPhaseLayerFilter_Impl objectVsBroadPhaseLayerFilterImpl = {
...
int main()
{
...

    {
        ...
        characterSettings.base.supportingVolume =
                {{0, 1, 0}, -cCharacterRadiusStanding}; // Accept contacts that touch the lower sphere of the capsule
        static const JPH_RVec3 characterVirtualPosition = {-5.0f, 0, 3.0f};

        auto mAnimatedCharacterVirtual = JPH_CharacterVirtual_Create(&characterSettings,
                                                                     &characterVirtualPosition,
                                                                     nullptr,
                                                                     0,
                                                                     system);
    }
